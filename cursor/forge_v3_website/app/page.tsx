...
export default function PromptForgePage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Header */}
      <header className="bg-black/50 border border-lead-gray/30 backdrop-blur-sm border-b border-border/50 sticky top-0 z-50">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <Badge variant="skre-outline" className="bg-black/50 border border-lead-gray/30 backdrop-blur-sm animate-fade-in">
              ...
              {generatedPrompts.length > 0 && (
                <Badge variant="skre-outline" className="bg-black/50 border border-lead-gray/30 backdrop-blur-sm animate-bounce-subtle">
      ...
      <div className="container mx-auto px-6 py-8">
        {/* Configuration Panel */}
        <Card className="bg-black/50 border border-lead-gray/30 backdrop-blur-sm p-6 mb-8 shadow-gold hover:shadow-gold-hover animate-fade-in">
        ...
        {/* Module Selection */}
        <Card className="bg-black/50 border border-lead-gray/30 backdrop-blur-sm p-6 mb-8 glow-success animate-fade-in">
        ...
        <Tabs defaultValue="generator" className="space-y-6">
          <TabsList className="bg-black/50 border border-lead-gray/30 backdrop-blur-sm">
          ...
          <TabsContent value="export" className="animate-slide-up">
            <Card className="bg-black/50 border border-lead-gray/30 backdrop-blur-sm p-6 shadow-gold hover:shadow-gold-hover">
