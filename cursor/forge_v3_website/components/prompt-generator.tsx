  ...
  return (
    <Card className="bg-black/50 border border-lead-gray/30 backdrop-blur-sm p-6 shadow-lead hover:shadow-lead-hover">
      <div className="flex items-center justify-between mb-4">
        ...
        {validationResult && (
          <Badge variant={validationResult.score >= 80 ? "default" : "secondary"} className="bg-black/50 border border-lead-gray/30 backdrop-blur-sm">
      ...
      {selectedModuleData && (
        <div className="mb-6 p-4 glass-strong rounded-lg">
          <div className="flex items-center gap-2 mb-2">
            <Badge variant="skre-outline">M{selectedModuleData.id.toString().padStart(2, "0")}</Badge>
      ...
      <div className="flex flex-wrap gap-2 mb-6">
        <Button onClick={handleGeneratePrompt} disabled={!selectedModule || isGenerating} className="shadow-gold hover:shadow-gold-hover">
        ...
        {generatedPrompt && (
          <>
            <Button
              ...
              className="bg-black/50 border border-lead-gray/30 backdrop-blur-sm bg-transparent"
            >
              <RefreshCw className="w-4 h-4 mr-2" />
              Reroll
            </Button>

            <Button variant="skre-outline" onClick={handleCopyPrompt} className="bg-black/50 border border-lead-gray/30 backdrop-blur-sm bg-transparent">
              <Copy className="w-4 h-4 mr-2" />
              Copy
            </Button>

            <Button variant="skre-outline" onClick={handleDownloadPrompt} className="bg-black/50 border border-lead-gray/30 backdrop-blur-sm bg-transparent">
