  ...
  return (
    <Card className="bg-black/50 border border-lead-gray/30 backdrop-blur-sm p-6 shadow-lead hover:shadow-lead-hover">
      <div className="flex items-center justify-between mb-4">
        ...
        {currentTest && (
          <Badge variant={currentTest.status === "success" ? "default" : "destructive"} className="bg-black/50 border border-lead-gray/30 backdrop-blur-sm">
      ...
      {/* Action Button */}
      <div className="mb-6">
        <Button onClick={handleRunTest} disabled={!generatedPrompt || isRunning} className="shadow-gold hover:shadow-gold-hover">
          {isRunning ? (
            <>
      ...
      <div>
        ...
        <Textarea
          ...
          className="min-h-[300px] font-mono text-sm bg-black/50 border border-lead-gray/30 backdrop-blur-sm"
          readOnly
        />
      </div>
    </Card>
